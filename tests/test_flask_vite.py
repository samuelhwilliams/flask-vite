...
@pytest.mark.parametrize("request_host, expected_status_code", (
    ("vite.domain.com", 200),
    ("myapp.com", 404),
    ("static.domain.com", 404)
))
def test_vite_serves_assets_from_explicit_host(mocker, request_host, expected_status_code):
    app = Flask(__name__, host_matching=True, static_host='static.domain.com')
    app.config['VITE_AUTO_INSERT'] = True
    Vite(app, vite_asset_host='vite.domain.com')
